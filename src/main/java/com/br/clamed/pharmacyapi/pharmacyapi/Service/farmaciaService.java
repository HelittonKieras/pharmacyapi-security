package com.br.clamed.pharmacyapi.pharmacyapi.Service;



import com.br.clamed.pharmacyapi.pharmacyapi.Dto.Error;
import com.br.clamed.pharmacyapi.pharmacyapi.Dto.cadastroFarmaciaOutput;
import com.br.clamed.pharmacyapi.pharmacyapi.Dto.farmaciaidOutput;
import com.br.clamed.pharmacyapi.pharmacyapi.Dto.listaFarmaciaOutput;
...
import com.br.clamed.pharmacyapi.pharmacyapi.Feign.Endereco;
import com.br.clamed.pharmacyapi.pharmacyapi.Feign.viacep;
...
public class farmaciaService {
    @Autowired
    private com.br.clamed.pharmacyapi.pharmacyapi.Repository.farmaciaRepository farmaciaRepository;

    @Autowired
    private com.br.clamed.pharmacyapi.pharmacyapi.Repository.enderecoRepository enderecoRepository;

    @Autowired
    private com.br.clamed.pharmacyapi.pharmacyapi.Feign.viacep viacep;
    ...
    public ResponseEntity<?> cadastrarFarmacia(@RequestBody farmaciaEntity farmacia) {
        ...
        if (farmacia.getEndereco().getCep() == null) {
            ...
            Endereco cep = viacep.buscarEnderecoPor(farmacia.getEndereco().getCep());
