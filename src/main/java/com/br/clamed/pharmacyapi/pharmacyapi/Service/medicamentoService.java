...
import com.br.clamed.pharmacyapi.pharmacyapi.Dto.listaMedicamentoOutput;
import com.br.clamed.pharmacyapi.pharmacyapi.Dto.medicamentoOutput;
import com.br.clamed.pharmacyapi.pharmacyapi.Dto.medicamentoidOutput;
...
public class medicamentoService {
    ...
    @Autowired
    private com.br.clamed.pharmacyapi.pharmacyapi.Repository.medicamentoRepository medicamentoRepository;
    ...
    public ResponseEntity<?> deletarPorID(@PathVariable Long id) {
        ...
        if(medicamentoRepository.existsById(id)){
            ...
            return ResponseEntity.accepted().body("Medicamento deletado com sucesso!: "+id);
